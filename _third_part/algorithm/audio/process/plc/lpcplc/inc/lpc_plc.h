...
/* change MINPP to 32(500Hz) to fix ringtone(around 440Hz) packet loss */
#define  MINPP   32    /* MINimum Pitch Period (in 16 kHz samples) */
...
/* OLALG(140) is choosen according to PESQ scores */
#define  OLALG	 140    /* OLA Length for 1st Good frame after erase */
...
/* Extrapolation buffer size is 24+MAXOS, thus OLALG should be less than 24+MAXOS.
 * Just set MAXOS to MAX OLALG
 */
#define  CODELAY (73)  /* Codec delay */
#define  MAXOS   (OLALG - CODELAY / 2)    /* MAXimum # of samples in waveform OffSet for time warping */
...
#define  MINPPD   4                 /* floor(MINPP/DECF); MIN PP in Decimated domain */
...
#define LBO (CODELAY/2) //12  /* Low band Offset in 16kHz domain */
