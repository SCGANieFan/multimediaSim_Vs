...
#include "plc_audio_cal_wave_match_by_crosscor_c.h"
...
public:
	...
	~wave_form_match_c() {}
public:
	INLINE void Init(wave_form_match_func_mode_e mode, audio_info_c* info) {
			_info = info;
#if 0
			_wave_form_match_ch = WaveMatchByCrossCor_c<Tref, Tcmp, Tnorm, _rShitf1, _rShitf0>::RunCh;
			_wave_form_match_all_ch = WaveMatchByCrossCor_c<Tref, Tcmp, Tnorm, _rShitf1, _rShitf0>::RunAllCh;
#else
			_wave_form_match_ch = wave_match_by_nf_run_ch;
			_wave_form_match_all_ch = wave_match_by_nf_run_all_ch;
#endif
	}
	INLINE i32 do_wave_form_match_ch(Tref* ref, Tcmp* cmp, u16 ch_select, i32 seek_sample, i32 match_sample) {
		return _wave_form_match_ch(
			ref,
			cmp,
			_info->_channels,
			ch_select,
	...
	INLINE i32 do_wave_form_match_all_ch(Tref* ref, Tcmp* cmp, i32 seek_sample, i32 match_sample) {
		return _wave_form_match_all_ch(
			ref,
			cmp,
			_info->_channels,
			seek_sample,
...
private:
#if 0
	STATIC i32 WaveFormMatch_Sum(wave_form_match_c* hd, void* ref, void* cmp, u16 ch_select, i32 seek_sample, i32 match_sample);
	STATIC i32 WaveFormMatch_Accorelation(wave_form_match_c* hd, void* ref, void* cmp, u16 ch_select, i32 seek_sample, i32 match_sample);
	STATIC i32 WaveFormMatch_Accorelation_AllCh(wave_form_match_c* hd, void* ref, void* cmp, u16 ch_select, i32 seek_sample, i32 match_sample);
#endif
private:
#if 1
	i32 (*_wave_form_match_ch)(Tref* ref, Tcmp* cmp, i16 channels, u16 channel_select, i32 seek_sample, i32 match_sample);
	i32 (*_wave_form_match_all_ch)(Tref* ref, Tcmp* cmp, i16 channels, i32 seek_sample, i32 match_sample);
#if 0
