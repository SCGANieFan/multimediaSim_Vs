...
public:
	...
	virtual b1 init(plc_memory_manger_c* mm, audio_info_c* info, overlap_add_window_choose_e window_choose, i32 overlap_samples) = 0;
	virtual void do_overlap_add(void* dst, void* src_decline, void* src_rise, i32 do_overlap_samples, i16 ch) = 0;
	virtual void do_overlap_add(void* dst, void* src_decline, void* src_rise, i32 do_overlap_samples) = 0;
protected:
	audio_info_c* _info;
...
template<class T>
class overlap_add_instance_c:public overlap_add_c
{
public:
	overlap_add_instance_c() {};
	~overlap_add_instance_c() {};
public:
	virtual b1 init(plc_memory_manger_c* mm, audio_info_c* info, overlap_add_window_choose_e window_choose, i32 overlap_samples) override {
		_info = info;
	...
	virtual void do_overlap_add(void* dst, void* src_decline, void* src_rise, i32 do_overlap_samples, i16 ch) override {
	...
	virtual void do_overlap_add(void* dst, void* src_decline, void* src_rise, i32 do_overlap_samples) override {
