...
#define MINIMP4_ALLOW_64BIT       0

#define MP4D_TRACE_SUPPORTED      0 // Debug trace
#define MP4D_TRACE_TIMESTAMPS     0
...
typedef struct
{
    ...
    unsigned sample_sync_count;
    unsigned* sample_sync;
    ...
    int entry_pos;
    //
    int entry_last_chunk;
    int entry_last_ns;
    int entry_last_offset;
    int entry_frame_bytes;
    //int entry_last_size;
    //jg--

    //bh++
    int chunk_offset_begin;
    int chunk_offset_div;
    //bh--
} MP4D_track_t;
