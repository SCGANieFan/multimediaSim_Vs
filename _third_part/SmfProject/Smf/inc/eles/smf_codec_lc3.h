...
typedef struct {
	...
	uint16_t sample_rate;//sample_rate/100
	uint16_t bitrate;//bitrate/100
	uint16_t channels;
	uint16_t frame_ms; //frame_ms * 10
	uint16_t epmode;
	uint16_t signal_len;
	uint16_t signal_len_red; //signal_len>>16
	uint16_t hrmode;
 ...
 */
EXTERNC void smf_lc3_decoder_register(void);
